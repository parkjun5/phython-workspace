...
def main():
    ...
    imgDino1 = pygame.image.load(os.path.join(image_path,"dino1.png"))
    imgDino2 = pygame.image.load(os.path.join(image_path,"dino2.png"))
    ...
    # tree
    imgTree = pygame.image.load(os.path.join(image_path,"tree.png"))
